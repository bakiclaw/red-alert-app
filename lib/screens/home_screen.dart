...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  final List<String> _availableAreas = [
    // Complete OREF Cities List - https://raw.githubusercontent.com/idodov/RedAlert/master/cities_name.md
    'אבו גוש',
    'אבו נוור',
    'אבו סנאן',
    'אבו קרינאת',
    ...
    'הרצליה - מערב',
    // Cities with apostrophes - properly escaped
    "אום אלג'נם",
    "אל-ח'וואלד מערב",
    "בועיינה-נוג'ידאת",
    "ביר הדאג'",
